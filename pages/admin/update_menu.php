...
<body class="bg-img update-std">
    ...
    <p>Current Image:</p>
    <img src="<?php echo htmlspecialchars($food['Image']); ?>" alt="Current Image" style="width: 150px; height: auto;">
<?php endif; ?>
                    ...
                    <label>Price:</label>
                    <input type="number" name="price" value="<?php echo htmlspecialchars($food['Price'] ?? ''); ?>" required><br>
